<div role="tabpanel" class="tab-pane" id="googleauth">
    <?php if (erLhcoreClassUser::instance()->hasAccessTo('lhgoogleauth','use_admin')) : ?>
        ...
        <a class="btn btn-sm btn-danger mb-1 me-1" ng-non-bindable href="<?php echo  erLhcoreClassDesign::baseurl('googleauth/remove')?>/<?php echo $loggedAccount->id?>">Logout - <?php echo htmlspecialchars($loggedAccount->givenName . ' '. 	$loggedAccount->familyName . '[' . $loggedAccount->email . ']')?></a>
        <?php endforeach; ?>
    <?php endif; ?>
    <br/>
